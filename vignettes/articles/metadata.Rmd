...
Before working with metadata, it is important to know which data releases are
available for each study. You can use the `get_releases()` function to retrieve
